...
* **Verifying safety of a MPC/SMC language: the motivation, the progress, and difficulties** (30 min)  
...
* **Formalizing Life Table in Isabelle/HOL** (45 min)  
...
* **Isabelle/HOLによる差分プライバシーの形式化** (30 min)  
  佐藤 哲也 @ 東京工業大学  
...
* **TBA** (30 min)  
  才川 隆文 @ 名古屋大学  
  TBA
* **スポーツ選手の移籍トレード先決定アルゴリズムのCoq/SSReflectによる検証** (30 min)  
  Kenta Inoue @ BELONG  
...
* **第一級継続の最適化を行う内在的型安全コンパイル** (30 min)  
  津山 勝輝 @ 東京工業大学  
...
* **簡易な検証器の実装を通じた形式証明の実践講義の可能性** (30 min)  
...
* **計算可能解析学とCoq / Computable Analysis and Coq** (30 min)  
...
* **差分プライバシー検証のための関係的ホーア論理の形式化** (15 min)  
  勝股 審也 @ 国立情報学研究所  
  ...
  化に関して報告する。
* **Coqを用いた内在的型付けに基づく確率的プログラミング言語の形式化** (30 min)  
