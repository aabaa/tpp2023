...
The presentation schedule is yet to be determined.

* **Verifying safety of a MPC/SMC language: the motivation, the progress, and difficulties** (30 min) <br/>
  Greg Weng @ Mercari x 名古屋大学多元数理科学研究科 <br/>
...
* **Formalizing Life Table in Isabelle/HOL** (45 min) <br/>
  伊藤 洋介 / Yosuke Ito @ ＳＯＭＰＯひまわり生命保険株式会社 / Sompo Himawari Life Insurance Inc. <br/>
...
* **Isabelle/HOLによる差分プライバシーの形式化** (30 min) <br/>
  佐藤 哲也 @ 東京工業大学 <br/>
...
* **TBA** (30 min) <br/>
  才川 隆文 @ 名古屋大学 <br/>
  TBA
* **スポーツ選手の移籍トレード先決定アルゴリズムのCoq/SSReflectによる検証** (30 min) <br/>
  Kenta Inoue @ BELONG <br/>
  チームスポーツの世界ではチーム同士で選手の移籍トレードを行うことがある。
  このトレードを複数チームで同時に行うときの選手の移籍先決定アルゴリズムについてCoq/SSReflectでの検証する。
* **Environment-friendly monadic equational reasoning for OCaml** (30 min) <br/>
...
* **第一級継続の最適化を行う内在的型安全コンパイル** (30 min) <br/>
  津山 勝輝 @ 東京工業大学<br/>
...
* **簡易な検証器の実装を通じた形式証明の実践講義の可能性** (30 min) <br/>
  Shunsuke Tsuchioka @ 東京工業大学情報理工学院 <br/>
...
* **計算可能解析学とCoq / Computable Analysis and Coq** (30 min) <br/>
  Holger Thies @ 京都大学 大学院人間・環境学研究科 <br/>
...
* **Coq と大規模言語モデルによる定理証明** (15 min) <br/>
  鈴木 彩加 @ 明治大学 <br/>
...
* **差分プライバシー検証のための関係的ホーア論理の形式化** (15 min) <br/>
  勝股 審也 @ 国立情報学研究所 <br/>
  ...
  基本定理と呼ばれる性質を満たすことを示している。本講演はこの形式
  化に関して報告する。
* **Coqを用いた内在的型付けに基づく確率的プログラミング言語の形式化** (30 min) <br/>
